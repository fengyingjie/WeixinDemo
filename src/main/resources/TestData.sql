...
INSERT INTO ROOMTBL(ROOMID, ROOMNAME, USEFLAG) VALUES('00202001','2楼北西安','1');
INSERT INTO ROOMTBL(ROOMID, ROOMNAME, USEFLAG) VALUES('00202002','2楼北北京','1');
INSERT INTO ROOMTBL(ROOMID, ROOMNAME, USEFLAG) VALUES('00202003','2楼北上海','1');
...
WHERE
     ROOMTBL.ROOMNAME = ?
 AND USEROOMTBL.USERID = ?
 AND USEROOMTBL.STARTTIME > ?
 AND USEROOMTBL.ENDTIME < ?
